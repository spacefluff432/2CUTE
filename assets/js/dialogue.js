        ...
        toriel: new XSpeaker({
            ...
            sprites: {
                pissed: new XSprite({
                    ...
                    textures: [
                        new XTexture({
                            source: 'https://raw.githubusercontent.com/Rovoska/undertale/master/sprites/images/spr_face_toriel_goawayasgore_0.png'
                        })
                    ]
                })
            }
        ...
        asgore: new XSpeaker({
            ...
            sprites: {
                sadgore: new XSprite({
                    ...
                    textures: [
                        new XTexture({
                            source: 'https://raw.githubusercontent.com/Rovoska/undertale/master/sprites/images/spr_sadgore_face_9.png'
                        })
                    ]
                }),
