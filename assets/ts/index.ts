   ...
   sprites: {
      ...
      susriel: new XSprite({
         ...
         textures: [
            new XTexture({
               source:
                  'https://raw.githubusercontent.com/Rovoska/undertale/master/sprites/images/spr_face_torieltalk_1.png'
            }),
            new XTexture({
               source:
                  'https://raw.githubusercontent.com/Rovoska/undertale/master/sprites/images/spr_face_torieltalk_0.png'
            })
         ]
      })
   },
