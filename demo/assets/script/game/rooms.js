...
function roomFactory(id, name, background, { h = 0, w = 0, x = 0, y = 0 }, doors, spawn, walls, extra) {
    ...
    const room = {
        ...
        layers: {
            ...
            foreground: [
                player,
                ...Object.entries(doors).map(([key, { bounds: { h = 0, w = 0, x = 0, y = 0 }, destination, direction, distance }]) => {
...
export const detector = new XHost();
export const spawns = {};
export const roomNames = {};
export const rooms = {
    castleRoad: roomFactory('castleRoad', 'New Home - Castle End', assets.backgrounds.castleRoad, { x: -2000, w: 2060 }, {
        x: {
    ...
    lastCorridor: roomFactory('lastCorridor', 'Last Corridor', assets.backgrounds.lastCorridor, { w: 1000 }, {
        x: {
    ...
    castleHook: roomFactory('castleHook', 'The Capitol - Main Hall', assets.backgrounds.castleHook, { x: 10, h: 300, w: 500 }, {
        x: {
    ...
    coffinStairs: roomFactory('coffinStairs', 'The Capitol - Annex', assets.backgrounds.coffinStairs, { x: -10, h: 300 }, {
        x: {
            bounds: { h: 10, w: 60, x: 120 },
    ...
    }, { x: 160, y: 130 }, [{ h: 540, w: 20, x: 100, y: 0 }, { h: 540, w: 20, x: 180, y: 0 }]),
    coffinRoom: roomFactory('coffinRoom', 'The Capitol - Storage', assets.backgrounds.coffinRoom, {}, {
        x: {
